...
var _PanelModule = __webpack_require__(19);

var _PanelModule2 = _interopRequireDefault(_PanelModule);

var _PanelModule3 = __webpack_require__(33);

var _PanelModule4 = _interopRequireDefault(_PanelModule3);
...
(function () {
    ...
    function init(window) {
        ...
        var pageInfoModule = new _PanelModule4.default(backgroundConnection, chrome.devtools.inspectedWindow.tabId, window.document.getElementById('page_info_module'));
        pageInfoModule.render();

        var linksCheckerModule = new _PanelModule2.default(backgroundConnection, chrome.devtools.inspectedWindow.tabId, window.document.getElementById('links_checker_module'));
    ...
    chrome.devtools.panels.create('OMTA', null, 'panel.html', function (panel) {
        _panel = panel;
...
function BackgroundConnection() {
    var _connection = chrome.runtime.connect({
        name: 'panel'
    });
...
var _LinksReport = __webpack_require__(32);

var _LinksReport2 = _interopRequireDefault(_LinksReport);
...
var PanelModule = function () {
    function PanelModule(connection, tabId, domNode) {
        var _this = this;
        ...
        setInterval(function () {
            _this.getSessionLinksCount();
        }, 1000);
    }

    _createClass(PanelModule, [{
        key: 'render',
            ...
            _reactDom2.default.render(_react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-danger',
                            onClick: this._stopSession },
                        'Stop session'
                    ),
                    _react2.default.createElement(_ProgressBar2.default, { success: this.linksData.statuses.success,
                    ...
                    _react2.default.createElement(
                        ...
                        this.linksData.sessionCount
                    ),
                    _react2.default.createElement(_LinksReport2.default, { list: this.linksData.list })
                )
            ), this.mainBlockNode);
        }
    }, {
        key: '_rescan',
        value: function _rescan() {
        ...
        key: 'addLink',
        value: function addLink(url, status) {
        ...
        key: 'getSessionLinksCount',
        value: function getSessionLinksCount() {
            this.connection.postMessage({
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(11),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),ha=__webpack_require__(15),ia=__webpack_require__(16),C=__webpack_require__(5);
...
var ProgressBar = function (_React$Component) {
    ...
    _createClass(ProgressBar, [{
        key: 'render',
        value: function render() {
            var percentSuccess = Math.round(this.props.success / this.props.all * 100) + '%';
            var percentWarning = Math.round(this.props.warning / this.props.all * 100) + '%';
            var percentError = Math.round(this.props.error / this.props.all * 100) + '%';

            return _react2.default.createElement(
                'div',
                { 'class': 'progress margin-top' },
                _react2.default.createElement('div', { 'class': 'progress-bar progress-bar-success',
                    style: { width: percentSuccess } }),
                _react2.default.createElement('div', { 'class': 'progress-bar progress-bar-warning',
                    style: { width: percentWarning } }),
                _react2.default.createElement('div', { 'class': 'progress-bar progress-bar-danger',
...
var LinksReport = function (_React$Component) {
    _inherits(LinksReport, _React$Component);

    function LinksReport() {
        _classCallCheck(this, LinksReport);

        return _possibleConstructorReturn(this, (LinksReport.__proto__ || Object.getPrototypeOf(LinksReport)).apply(this, arguments));
    }

    _createClass(LinksReport, [{
        key: 'render',
        value: function render() {
            ...
            this.props.list.forEach(function (status, url) {
                ...
                statuses.get(status).urls.push(_react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                        'a',
            ...
            statuses.forEach(function (obj, status) {
                tabs.push(_react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: '#status' + status, 'aria-controls': 'status' + status, role: 'tab',
                            'data-toggle': 'pill' },
                        obj.name,
                        ' ',
                        _react2.default.createElement(
                ...
                tabsContent.push(_react2.default.createElement(
                    'div',
                    { role: 'tabpanel', className: 'tab-pane', id: 'status' + status },
                    _react2.default.createElement(
                        'p',
                        null,
                        obj.urls
        ...
        value: function render() {
            _reactDom2.default.render(_react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'panel-heading', role: 'tab', id: 'pageInfo' },
                        _react2.default.createElement(
                            'h5',
                            { className: 'panel-title' },
                            _react2.default.createElement(
                                'a',
                                { role: 'button', 'data-toggle': 'collapse', href: '#pageInfoPanel', 'aria-expanded': 'true',
                    ...
                    _react2.default.createElement(
                        'div',
                        { id: 'pageInfoPanel', className: 'panel-collapse collapse in', role: 'tabpanel',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'panel-heading', role: 'tab', id: 'cookiesInfo' },
                        _react2.default.createElement(
                            'h5',
                            { className: 'panel-title' },
                            _react2.default.createElement(
                                'a',
                                { role: 'button', 'data-toggle': 'collapse', href: '#cookiesPanel', 'aria-expanded': 'false',
                    ...
                    _react2.default.createElement(
                        'div',
                        { id: 'cookiesPanel', className: 'panel-collapse collapse', role: 'tabpanel',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                { id: 'cookies', style: { overflowWrap: "break-word" } },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'panel-heading', role: 'tab', id: 'metaTags' },
                        _react2.default.createElement(
                            'h5',
                            { className: 'panel-title' },
                            _react2.default.createElement(
                                'a',
                                { role: 'button', 'data-toggle': 'collapse', href: '#metatagsPanel', 'aria-expanded': 'false',
                    ...
                    _react2.default.createElement(
                        'div',
                        { id: 'metatagsPanel', className: 'panel-collapse collapse', role: 'tabpanel', 'aria-labelledby': 'metaTags' },
                        _react2.default.createElement(
                            'div',
                            { className: 'panel-body' },
                            _react2.default.createElement(
